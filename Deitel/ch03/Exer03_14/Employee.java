 ...
 * instência - um primeiro nome (tipo String), um sobrenome (tipo String) e um salário
 * mensal (double). Sua classe dever ter um construtor que inicializa as três variáveis de
